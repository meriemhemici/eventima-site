...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/ModifierOffre.css">
...
<body style="overflow-y: auto;">
    ...
    <header id="header">
     ...
     <div>
        <h1><b>Ajouter un Offre</b></h1> <br><br>
...
<input type="hidden" name="idArt" value="<?php echo $idArticle; ?>">
      ...
      <label for="prix">Ancien Prix:</label>
        <input type="number" id="prix" name="prix"><br>

        <label for="prix">Nouveau Prix:</label>
        <input type="number" id="Newprix" name="Newprix"><br>
