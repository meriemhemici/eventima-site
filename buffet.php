<html>
    ...
    <body>
        <!--header-->
        <header id="header">
            <a href="test.html" class="logo"> <span>E</span>ventima</a>
            <ul>
                <li><a href="Nos-servicec.html" class="active" >Nos service</a></li>
                ...
                <li><a href="connecter.html"> <button id="login-btn">Se connecter</button></a></li>
        ...
        <!--header-->
        <div class="imgtop">
            <img src="top.png" alt="" width="100%" height="300px">
        ...
        <div class="title"><h3><b>Buffet</b> </h3> </div>
         ...
         <div class="photo-gallery">
            <div class="pic5 salé">
                <img src="salé.jfif" alt="" >
            </div>
            <div class="pic6 sucre">
                <img src="sucre.jfif" alt="" >
            </div>
            <div class="pic7 tarte">
                <img src="tarte.jfif" alt="" >
            </div>
