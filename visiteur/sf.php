<html>
    ...
    <body style="overflow-y: auto;">
        ...
        <!--body-->
        <div class="title"><h3><b>Salles  des  fêtes</b> </h3> </div>
        <!--nos service-->
...
$result = mysqli_query($db, "SELECT * FROM article WHERE category='endroit' AND subcat='Salle-des-fêtes' ");
    ...
    echo '<li>
            <div class="post">
                ...
                <div class="post-preview">
                    ...
                    <a href="detailles.html" class="btn read"> Read more</a>
                    </div>
            </div>
            <hr>
          </li>';
