...
.main-content .post .read{
 ...
 .main-content .post .read:hover{
    ...
    <body style="overflow-y: auto;">
        ...
        <!--body-->
        <div class="title"><h3><b>Les hôtels </b> </h3> </div>
        <!--nos service-->
    ...
    <div class="main-content">
        <ul >
            <?php
                ...
                $result = mysqli_query($db, "SELECT * FROM article WHERE category='endroit' AND subcat='hotel' ");
                    ...
                    echo '<li>
                            <div class="post">
                                ...
                                <div class="post-preview">
                                    ...
                                    <a href="detailles.html?id='.$row['id'].'" class="btn read"> Read more</a>
                                    </div>
                            </div>
                            <hr>
                        </li>';
