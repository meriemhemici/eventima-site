 ...
 .main-content .post .read:hover{
    ...
    <body style="overflow-y: auto;">
         ...
         <header id="header">
            ...
            <ul>
                <li><a href="Accueil.html" class="active" >Nos service</a></li>
        ...
        <!--body-->
        <div class="title"><h3><b>Les endroits</b> </h3> </div>
        <!--nos service-->
    ...
    $result = mysqli_query($db, "SELECT * FROM article WHERE category='endroit' AND subcategory='Hôtel'");
